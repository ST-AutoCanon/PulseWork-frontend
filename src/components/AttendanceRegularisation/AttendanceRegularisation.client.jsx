...
import LeaveRegularisationModal from "./LeaveRegularisationModal.client";
import LoginHourSettingsModal from "./LoginHourSettingsModal.client";
import PunchPolicyModal from "./PunchPolicyModal.client";
import Modal from "../Modal/Modal.client";
import "./AttendanceRegularisation.css";
...
export default function AttendanceRegularisation() {
  ...
  const [showLoginHourSettingsModal, setShowLoginHourSettingsModal] =
    useState(false);
  const [showPunchPolicyModal, setShowPunchPolicyModal] = useState(false);
          ...
          {canManageLoginHours ? (
            <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
              <button
                type="button"
                className="ar-secondary-btn"
                onClick={() => setShowPunchPolicyModal(true)}
              >
                Create Punch Policy
              </button>
              <button
  ...
  return (
    <div className="ar-page">
      ...
      <PunchPolicyModal
        isOpen={showPunchPolicyModal}
        onClose={() => setShowPunchPolicyModal(false)}
      />
