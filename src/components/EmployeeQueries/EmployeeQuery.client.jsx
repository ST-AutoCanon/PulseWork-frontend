        ...
        <div className="emp-sidebar">
          ...
          <div className="emp-query-list">
            {loading ? (
              ...
              queries
                .filter((qq) =>
                  showResolved ? qq.status === "closed" : qq.status !== "closed"
                )
                .map((qq) => (
                  <div
                    key={qq.id}
              ...
              <div className="employee-query-modal">
                ...
                <div className="feedback-options">
                  <p className="feedback-para">
                    Great!! <br />
                    I hope your query has been resolved. If not, click “Cancel”
                    to continue. Please provide your valuable Rating and
                    Feedback before you end your conversation. <br />
