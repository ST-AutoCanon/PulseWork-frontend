...
// //   // Unified fetch for clearance items (KT + Assets)
...
// //   // Fetch ALL team exit requests
// //   const fetchAllTeamRequests = async () => {
// //     try {
// //       const url = role === "hr" ? `${BACKEND_URL}/api/exit/all` : `${BACKEND_URL}/api/exit/my-team/all`;
...
// //       console.log("[TEAM REQUESTS] Loaded:", requests.length, "Resigned:", resignedClearance.length);
// //      if (role === "hr" && !finalLwd) {
// //   alert("Final LWD is required for HR approval");
// //   return;
// // }
// //     } catch (err) {
// //       console.error("[TEAM REQUESTS] Fetch failed:", err.message);
// //     }
// //   };
...
// //       console.log("[TEAM MEMBERS] Loaded:", res.data.members?.length || 0);
// //     } catch (err) {
// //       console.error(err);
// //       setTeamMembers([]);
// //     } finally {
...
// //   // Re-fetch clearance when review modal opens for clearance type
// //   useEffect(() => {
...
// //       return setErrorMessage("Topic and description are required");
// //     }
// //     setLoading(true);
// //     try {
// //       await axios.post(
...
// //           itemType: "KT",
// //           title: newKtForm.topic,
// //           description: newKtForm.description,
// //           plannedDate: newKtForm.completedDate || null,
// //           status: newKtForm.status || "pending",
// //           attachedFiles: newKtForm.document ? [newKtForm.document] : null,
// //         },
// //         {
// //           headers: {
// //             "x-api-key": API_KEY,
...
// //       console.log("[ADD KT] Success");
// //     } catch (err) {
// //       setErrorMessage(err.response?.data?.error || "Failed to add KT plan");
// //       console.error("[ADD KT] Failed:", err);
// //     } finally {
// //       setLoading(false);
// //     }
// //   };
...
// //   // ── Approve KT/Asset item ──
// //  const handleApproveItem = async (itemId, approved, itemType, item) => {
...
// //     setKtPlans(prev =>
// //       prev.map(k =>
// //         k.id === itemId ? { ...k, [`${role}_approved`]: approved } : k
// //       )
// //     );
// //   } else if (itemType === "ASSET") {
// //     setAssets(prev =>
// //       prev.map(a =>
// //         a.id === itemId ? { ...a, [`${role}_approved`]: approved } : a
// //       )
// //     );
// //   }
...
// //   setLoading(true);
// //   try {
// //     const currentRole = role?.toLowerCase() === "manager" ? "supervisor" : role?.toLowerCase();
// //     if (!["supervisor", "hr"].includes(currentRole)) {
...
// //     console.log(`[APPROVE ${itemType}] Success for ID ${itemId}:`, approved);
// //   } catch (err) {
// //     console.error(`[APPROVE ${itemType}] Failed for ID ${itemId}:`, err.response?.data || err.message);
...
// //       await fetchSelfRequest();
// //       await fetchAllTeamRequests();
// //       console.log("[FINALIZE EXIT] Success for ID:", exitId);
// //     } catch (err) {
// //       setErrorMessage(err.response?.data?.error || "Failed to finalize exit");
...
// //       console.log("[APPLY RESIGNATION] Success");
// //     } catch (err) {
...
// //     console.log("[REVIEW ACTION]", { reviewType, action, role, finalLwd, selectedRequest });
// //     setLoading(true);
// //     setErrorMessage("");
// //     try {
// //       const payload = {
...
// //           } else {
// //             throw new Error(`Unsupported HR action for resignation: ${action}`);
// //           }
// //         }
...
// //         }
// //         else {
// //           throw new Error(`Unauthorized role for normal resignation review: ${role} (effective: ${effectiveRole})`);
// //         }
// //       }
...
// //         }
// //         else {
// //           throw new Error(`Unauthorized role for withdrawal review: ${role} (effective: ${effectiveRole})`);
// //         }
// //       }
// //       else {
...
// //         {errorMessage && <div className="exit-flow-error-banner">{errorMessage}</div>}

// //         {/* Tabs */}
// //         <div className="exit-flow-tabs-wrapper">
// //           <div className="exit-flow-tabs">
// //             <button
// //               className={`exit-flow-tab ${activeTab === "self" ? "active" : ""}`}
...
// //             {hasTeam && (
// //               <button
// //                 className={`exit-flow-tab ${activeTab === "team" ? "active" : ""}`}
...
// //             {isHr && (
// //               <button
// //                 className={`exit-flow-tab ${activeTab === "all" ? "active" : ""}`}
...
// //           <div className="exit-flow-card exit-flow-self-view">
// //             {selfRequest && selfRequest.is_active === 1 ? (
// //               <div className="exit-flow-section">
// //                 <h2 className="exit-flow-title">My Resignation Status</h2>
...
// //                   </div>
// //                   <div className="status-item">
// //                     <span className="status-label">Proposed LWD</span>
// //                     <span className="status-value">
...
// //                       <span className="status-label">Supervisor Comment</span>
// //                       <div className="comment-box">{selfRequest.supervisor_comment}</div>
// //                     </div>
// //                   )}
// //                   <div className="status-item">
// //                     <span className="status-label">HR</span>
...
// //                     <div className="status-item full-width withdrawal-status">
...
// //                         <p className="awaiting">Awaiting HR decision</p>
// //                       )}
...
// //                   <div className="withdraw-section mt-6">
...
// //                     />
// //                     <button
// //                       className="btn btn-warning full-width mt-4"
...
// //                   <div
// //                     className={`outcome-box outcome-${selfRequest.final_outcome.toLowerCase()}`}
...
// //                           ) : (
// //                             <>
// //                               <div className="exit-flow-tabs-wrapper mb-4">
// //                                 <div className="exit-flow-tabs">
// //                                   <button
// //                                     className={`exit-flow-tab ${clearanceActiveTab === "kt" ? "active" : ""}`}
// //                                     onClick={() => setClearanceActiveTab("kt")}
// //                                   >
// //                                     KT Plan
// //                                   </button>
// //                                   <button
// //                                     className={`exit-flow-tab ${clearanceActiveTab === "assets" ? "active" : ""}`}
...
// //                                                     onChange={(e) =>
// //                                                       handleApproveItem(kt.id, e.target.checked)
// //                                                     }
...
// //                     )}
// //                     {selfRequest.final_outcome === "REJECTED" && (
// //                       <p className="outcome-message text-sm mt-4">
...
// //                         onClick={fetchSelfRequest}
// //                       >
// //                         Refresh Status / Submit New Request
// //                       </button>
// //                     )}
// //                   </div>
// //                 ) : null}

// //                 {/* Submit form - only show if no active/final outcome */}
// //                 {(!selfRequest ||
// //                   !selfRequest.final_outcome ||
// //                   selfRequest.final_outcome !== "RESIGNED") && (
// //                   <>
// //                     <h2 className="exit-flow-title">Submit Resignation Request</h2>
// //                     <form className="exit-flow-form">
...
//         //   <div className="exit-flow-team-view space-y-8">
//         //     {loadingTeamMembers ? (
...
//         //     ) : (
//         //       <>
//         //         <div className="exit-flow-team-panel">
//         //           <h2 className="exit-flow-panel-title mb-3">
...
//         //         <div className="exit-flow-team-panel">
//         //           <h2 className="exit-flow-panel-title mb-3">Pending Resignations (My Team)</h2>
...
//         //         {/* Pending Withdrawals */}
//         //         <div className="exit-flow-team-panel">
//         //           <h2 className="exit-flow-panel-title mb-3">Pending Withdrawal Requests (My Team)</h2>
...
// //                 {/* Resigned & Clearance (supervisor, manager, hr) */}
// //                 {["hr", "supervisor", "manager"].includes(role) && (
// //                   <div className="exit-flow-team-panel mt-8 border-t pt-6">
// //                     <h2 className="exit-flow-panel-title mb-3">
...
// //         {/* ALL EMPLOYEES VIEW (HR only) */}


// //         {role === "hr" && activeTab === "all" && (
// //           <div className="exit-flow-team-view space-y-8">
// //             <div className="exit-flow-team-panel">
// //               <h2 className="exit-flow-panel-title mb-3">
...
// //         {/* Review Modal */}
// //         {selectedRequest && (
// //           <div className="exit-flow-modal-backdrop">
// //             <div className="exit-flow-modal-content">
// //               <h3 className="exit-flow-modal-title">
// //                 {selectedRequest.type === "normal" ? "Resignation Review" :
// //                  selectedRequest.type === "withdrawal" ? "Withdrawal Review" :
// //                  "Clearance Review"}
// //               </h3>
// //               <div className="exit-flow-modal-info">
// //                 <div className="exit-flow-modal-row">
// //                   <span className="exit-flow-modal-label">Employee</span>
// //                   <span className="exit-flow-modal-value">{selectedRequest.employee_id}</span>
// //                 </div>
// //                 {selectedRequest.type !== "clearance" && (
// //                   <>
// //                     <div className="exit-flow-modal-row">
// //                       <span className="exit-flow-modal-label">Reason</span>
// //                       <span className="exit-flow-modal-value">{selectedRequest.reason}</span>
// //                     </div>
// //                     <div className="exit-flow-modal-row">
// //                       <span className="exit-flow-modal-label">Proposed LWD</span>
// //                       <span className="exit-flow-modal-value">{selectedRequest.proposed_lwd || "—"}</span>
// //                     </div>
// //                   </>
// //                 )}
// //                 {selectedRequest.type === "withdrawal" && (
// //                   <div className="modal-row full-width">
// //                     <span className="exit-flow-modal-label">Withdrawal Reason</span>
// //                     <span className="exit-flow-modal-value">{selectedRequest.withdrawal_reason}</span>
// //                   </div>
// //                 )}
// //               </div>
...
// //     <div>
// //       <h4 className="font-medium mb-4">KT Plans</h4>
// //       {ktPlans.length === 0 ? (
// //         <p className="text-gray-500">No KT plans added yet.</p>
// //       ) : (
// //         ktPlans.map((kt) => (
// //           <div key={kt.id} className="bg-gray-50 p-4 rounded border mb-3 relative">
// //             <h5 className="font-medium">{kt.title}</h5>
// //             {kt.description && <p className="text-sm mt-1">{kt.description}</p>}
// //             {kt.attached_files?.length > 0 && (
// //               <div className="mt-2 text-sm">
// //                 <p className="font-medium">Files:</p>
// //                 <ul className="list-disc pl-5">
// //                   {kt.attached_files.map((f, i) => <li key={i}>{f}</li>)}
// //                 </ul>
// //               </div>
// //             )}
// //             <p className="mt-2 text-sm">
// //               Status: <span className="font-medium">{kt.status || "pending"}</span>
// //             </p>
...
// //                   />
// //                   <span className="ml-2 text-sm font-medium">Supervisor Approved</span>
// //                 </label>
// //               )}
...
// //                     className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
// //                   />
// //                   <span className="ml-2 text-sm font-medium">HR Approved</span>
// //                 </label>
// //               )}
// //             </div>

// //             {loading && <div className="absolute inset-0 bg-white/50 flex items-center justify-center text-sm">Saving...</div>}
// //           </div>
// //         ))
// //       )}
// //     </div>
...
// //     <div>
// //       <h4 className="font-medium mb-4">Assets</h4>
// //       {assets.length === 0 ? (
// //         <p className="text-gray-500">No assets added yet.</p>
// //       ) : (
// //         assets.map((asset) => (
// //           <div key={asset.id} className="bg-gray-50 p-4 rounded border mb-3 relative">
// //             <h5 className="font-medium">{asset.title}</h5>
...
// //   </div>
// // )}
// //               <div className="exit-flow-modal-actions">
// //                 <button
...
// //           <div className="exit-flow-modal-backdrop">
// //             <div className="exit-flow-modal-content" style={{ maxWidth: '520px' }}>
// //               <div className="kt-modal-header">
// //                 <h3 className="kt-modal-title">Add Knowledge Transfer Plan</h3>
// //                 <button
// //                   onClick={() => setShowAddKTModal(false)}
...
// //                     Topic <span className="kt-required">*</span>
// //                   </label>
// //                   <input
// //                     type="text"
// //                     value={newKtForm.topic}
// //                     onChange={(e) => setNewKtForm({ ...newKtForm, topic: e.target.value })}
...
// //                 <div className="kt-form-group">
// //                   <label className="kt-form-label">
// //                     Description <span className="kt-required">*</span>
// //                   </label>
// //                   <textarea
// //                     value={newKtForm.description}
// //                     onChange={(e) => setNewKtForm({ ...newKtForm, description: e.target.value })}
// //                     rows={5}
// //                     className="kt-form-textarea"
// //                     placeholder="Detailed notes about what needs to be handed over..."
// //                   />
// //                 </div>
// //                 <div className="kt-form-group">
// //                   <label className="kt-form-label">Upload Documents (multiple allowed)</label>
// //                   <div className="kt-file-upload-container">
// //                     <label className="kt-file-upload-btn">
// //                       Choose files
// //                       <input
// //                         type="file"
// //                         multiple
...
// //                           setNewKtForm({ ...newKtForm, document: fileNames });
// //                         }}
// //                         className="kt-file-input-hidden"
// //                       />
// //                     </label>
// //                     <span className="kt-file-selected">
// //                       {newKtForm.document ? `Selected: ${newKtForm.document}` : "No file chosen"}
// //                     </span>
// //                   </div>
// //                 </div>
// //                 <div className="kt-form-row">
// //                   <div className="kt-form-group kt-form-group-half">
// //                     <label className="kt-form-label">Status</label>
// //                     <select
// //                       value={newKtForm.status}
// //                       onChange={(e) => setNewKtForm({ ...newKtForm, status: e.target.value })}
// //                       className="kt-form-select"
// //                     >
...
// //                   </div>
// //                   <div className="kt-form-group kt-form-group-half">
// //                     <label className="kt-form-label">Completed Date</label>
// //                     <input
// //                       type="date"
// //                       value={newKtForm.completedDate}
// //                       onChange={(e) => setNewKtForm({ ...newKtForm, completedDate: e.target.value })}
// //                       className="kt-form-input"
// //                     />
// //                   </div>
// //                 </div>
...
// //                 <button
// //                   onClick={() => setShowAddKTModal(false)}
// //                   className="kt-btn kt-btn-cancel"
// //                 >
// //                   Cancel
// //                 </button>
// //                 <button
// //                   onClick={handleAddKt}
// //                   disabled={loading || !newKtForm.topic.trim() || !newKtForm.description.trim()}
// //                   className="kt-btn kt-btn-primary"
// //                 >
// //                   {loading ? "Adding..." : "Add KT Plan"}
// //                 </button>
// //               </div>
// //             </div>
// //           </div>,
...
// //       });
// //       setResignedClearance(requests.filter(r => r.final_outcome === "RESIGNED"));
// //       console.log("[TEAM REQUESTS] Loaded:", requests.length, "Resigned:", requests.filter(r => r.final_outcome === "RESIGNED").length);
// //     } catch (err) {
// //       console.error("[TEAM REQUESTS] Fetch failed:", err.message);
// //     }
// //   };
...
// //     alert("KT plan added successfully!");
// //   } catch (err) {
...
// //   }
// // };
// // // Helper: Normalize file path/url to a clean backend-relative path
// // // In ExitFlow.client.jsx – replace the existing functions

// // const normalizeFilePath = (file) => {
// //   if (!file) return null;

// //   // If it's already a full URL → return the path part only (without domain)
// //   if (file.startsWith('http://') || file.startsWith('https://')) {
// //     try {
// //       const url = new URL(file);
// //       return url.pathname.replace(/^\//, ''); // e.g. "exitflowuploads/1769591770558-481750736.png"
// //     } catch (e) {
...
// //   // If it's just a filename (old data) → prepend folder
// //   if (!file.includes('/')) {
// //     return `exitflowuploads/${file}`;
// //   }

// //   // Otherwise assume it's already correct relative path
// //   return file;
// // };
// // // Helper – make sure path is always correct relative to backend base
// // const getFileUrl = (rawPath) => {
// //   if (!rawPath) return null;

// //   let cleanPath = rawPath
// //     .replace(/\\/g, '/')           // Windows → forward slashes
// //     .replace(/^exitflowuploads[\/\\]?/, '')   // remove prefix if already present
...
// // // ── View ──
// // // Temporary debug version - remove auth to isolate
...
// //     let approvalAs = "supervisor"; // default

// //     if (activeTab === "all") {
// //       approvalAs = "hr";
// //     } else if (activeTab === "team" && role === "hr") {
// //       approvalAs = "supervisor"; // HR acting in supervisor capacity for their team
...
// //     // Optional: force refresh from DB to confirm
...
// //       );
// //       if (res.data?.success) {
// //         alert("Exit finalized successfully!");
// //         setSelectedRequest(null);
// //         await fetchSelfRequest();
// //         await fetchAllTeamRequests();
// //       } else {
...
// //       alert("Finalize failed: " + (err.response?.data?.error || "Check console"));
// //     } finally {
// //       setLoading(false);
// //     }
// //   };
...
// //             <div className="exit-flow-modal-row">
// //               <span className="exit-flow-modal-label">Proposed LWD</span>
// //               <span className="exit-flow-modal-value">
// //                 {selectedRequest.proposed_lwd ? new Date(selectedRequest.proposed_lwd).toLocaleDateString() : "—"}
// //               </span>
// //             </div>
// //           </>
// //         )}
...
// //   <div className="mt-2 space-y-2">
// //     <p className="text-xs font-medium text-gray-700">Uploaded files:</p>
// //     {kt.attached_files.map((rawFile, idx) => {
// //       const fileName = normalizeFilePath(rawFile).split('/').pop() || 'file';
// //       return (
// //         <div key={idx} className="flex items-center justify-between bg-gray-100 p-2 rounded">
// //           <span className="text-sm text-gray-700 truncate">{fileName}</span>
// //           <div className="flex gap-2">
// //             <button
// //               className="btn btn-secondary btn-sm"
// //               onClick={() => viewFile(rawFile)}
// //             >
// //               View
// //             </button>
// //             <button
// //               className="btn btn-outline btn-sm"
// //               onClick={() => downloadFile(rawFile, fileName)}
// //             >
// //               Download
// //             </button>
// //           </div>
...
// //                 {loading ? "Processing..." : "Finalize Exit & Clearance"}
// //               </button>
// //               {(ktPlans.some(kt => !kt.hr_approved) || assets.some(a => !a.hr_approved)) && !loading && (
// //                 <p className="text-red-600 text-sm mt-2 text-center">
// //                   All HR approvals must be completed before finalizing
// //                 </p>
// //               )}
// //             </div>
// //           )}

// //           {/* Supervisor/Manager Confirm */}
// //           {["supervisor", "manager"].includes(role) && (
...
// //                 className="btn btn-success"
// //                 onClick={() => {
// //                   alert("Approvals confirmed! Changes have been saved.");
// //                   setSelectedRequest(null);
// //                 }}
// //                 disabled={loading}
// //               >
...
// //       {/* ── NORMAL / WITHDRAWAL REVIEW EXTRA FIELDS ── */}
// //       {selectedRequest.type !== "clearance" && (
...
// //           {/* Supervisor: Recommended LWD */}
// //           {role === "supervisor" && selectedRequest.type === "normal" && (
// //             <div>
// //               <label className="block text-sm font-medium text-gray-700 mb-1">Recommended LWD (optional)</label>
// //               <input
// //                 type="date"
...
// //           {/* HR: Final LWD - required for Approve */}
// //           {role === "hr" && selectedRequest.type === "normal" && (
// //             <div>
// //               <label className="block text-sm font-medium text-gray-700 mb-1">
// //                 Final LWD <span className="text-red-600">*</span>
// //               </label>
// //               <input
// //                 type="date"
// //                 value={finalLwd}
...
// //       {/* Action Buttons */}
// //       <div className="exit-flow-modal-actions mt-6 flex justify-end gap-3">
// //         <button
...
// //               onClick={() => handleReviewAction("normal", "APPROVED")}
// //               disabled={role === "hr" && !finalLwd} // disable if HR and no final LWD
// //             >
// //               {role === "hr" ? "Final Approve" : "Approve"}
// //             </button>
// //             <button
...
// //     </label>
// //     <span className="kt-file-selected">
// //       {newKtForm.documents.length > 0
// //         ? `Selected: ${newKtForm.documents.map(f => f.name).join(", ")}`
// //         : "No file chosen"}
// //     </span>
// //   </div>
// // </div>
...
// //   //       completedDate: "",
// //   //     });
// //   //     alert("KT plan updated successfully!");
// //   //   } catch (err) {
// //   //     console.error("[handleEditKt] ERROR:", err);
// //   //     const msg = err.response?.data?.error || err.message || "Failed to update KT plan";
// //   //     setErrorMessage(msg);
// //   //     alert("Error: " + msg);
// //   //   } finally {
// //   //     setLoading(false);
...
// //         {/* ── REST OF YOUR TABS (team / all) ── remains unchanged ── */}
...
// //       ) : (
// //         ktPlans.map((kt) => (
// //          <div key={kt.id} className="bg-gray-50 p-4 rounded border mb-4 relative">
// //   <h5 className="font-medium text-gray-900">{kt.title}</h5>
// //   {kt.description && <p className="text-sm mt-1.5 text-gray-600">{kt.description}</p>}
...
// //           <div
// //             key={idx}
// //             className="flex items-center justify-between bg-white p-2.5 rounded border border-gray-200 text-sm shadow-sm"
// //           >
// //             <span className="text-gray-700 truncate flex-1 mr-3">{fileName}</span>
// //             <div className="flex gap-2">
// //               <button
...
//           <div className="exit-flow-tabs">
//             <button
//               className={`exit-flow-tab ${activeTab === "self" ? "exit-flow-tab--active" : ""}`}
//               onClick={() => setActiveTab("self")}
//             >
//               My Status
//             </button>
//             {hasTeam && (
//               <button
//                 className={`exit-flow-tab ${activeTab === "team" ? "exit-flow-tab--active" : ""}`}
//                 onClick={() => setActiveTab("team")}
//               >
//                 My Team
//               </button>
...
//             {isHr && (
//               <button
//                 className={`exit-flow-tab ${activeTab === "all" ? "exit-flow-tab--active" : ""}`}
//                 onClick={() => setActiveTab("all")}
//               >
//                 All Employees
//               </button>
...
//               <div className="exit-flow-section">
//                 <h2 className="exit-flow-title">My Resignation Status</h2>
//                 <div className="exit-flow-status-grid">
//                   <div className="exit-flow-status-item">
//                     <span className="exit-flow-status-label">Reason</span>
//                     <span className="exit-flow-status-value">
//                       {selfRequest.reason}
//                       {selfRequest.other_reason && ` (${selfRequest.other_reason})`}
//                     </span>
//                   </div>
//                   <div className="exit-flow-status-item">
//                     <span className="exit-flow-status-label">Proposed LWD</span>
//                     <span className="exit-flow-status-value">
//                       {selfRequest.proposed_lwd
//                         ? new Date(selfRequest.proposed_lwd).toLocaleDateString()
//                         : "—"}
...
//                   </div>
//                   <div className="exit-flow-status-item">
//                     <span className="exit-flow-status-label">Supervisor</span>
//                     <span className={`badge badge-${(selfRequest.supervisor_status || "pending").toLowerCase()}`}>
//                       {selfRequest.supervisor_status || "Pending"}
//                     </span>
//                   </div>
//                   {selfRequest.supervisor_comment && (
//                     <div className="exit-flow-status-item exit-flow-full-width">
//                       <span className="exit-flow-status-label">Supervisor Comment</span>
//                       <div className="exit-flow-comment-box">{selfRequest.supervisor_comment}</div>
//                     </div>
//                   )}
//                   <div className="exit-flow-status-item">
//                     <span className="exit-flow-status-label">HR</span>
//                     <span className={`badge badge-${(selfRequest.hr_status || "pending").toLowerCase()}`}>
//                       {selfRequest.hr_status || "Pending"}
//                     </span>
//                   </div>
//                   {selfRequest.withdrawal_requested_at && (
//                     <div className="exit-flow-status-item exit-flow-full-width exit-flow-withdrawal-status">
//                       <h3>Withdrawal Request</h3>
//                       <p><strong>Status:</strong> {selfRequest.withdrawal_supervisor_status || "Pending"}</p>
//                       {selfRequest.withdrawal_supervisor_status === "APPROVED" && (
//                         <p className="exit-flow-awaiting">Awaiting HR decision</p>
//                       )}
//                       {selfRequest.withdrawal_reason && (
//                         <p><strong>Reason:</strong> {selfRequest.withdrawal_reason}</p>
//                       )}
...
//                 </div>
//                 {!selfRequest.withdrawal_requested_at && !selfRequest.final_outcome && (
//                   <div className="exit-flow-withdraw-section mt-6">
//                     <h3>Request to Withdraw Resignation</h3>
//                     <p className="exit-flow-help-text">
//                       You can still cancel this resignation before final approval.
//                     </p>
//                     <textarea
//                       placeholder="Reason for withdrawal..."
...
//                     />
//                     <button
//                       className="btn btn-warning exit-flow-full-width mt-4"
//                       onClick={handleWithdraw}
//                       disabled={loading}
//                     >
//                       {loading ? "Submitting..." : "Request Withdrawal"}
...
//                 {selfRequest && selfRequest.final_outcome ? (
//                   <div
//                     className={`exit-flow-outcome-box exit-flow-outcome--${selfRequest.final_outcome.toLowerCase()}`}
//                     style={{ marginBottom: "2rem" }}
//                   >
//                     <div className="exit-flow-outcome-icon">
//                       {selfRequest.final_outcome === "RESIGNED" && "✓"}
//                       {selfRequest.final_outcome === "REJECTED" && "✗"}
//                       {selfRequest.final_outcome === "WITHDRAWN" && "↩"}
//                     </div>
//                     <h2 className="exit-flow-outcome-title">
//                       {selfRequest.final_outcome === "RESIGNED" && "Resignation Approved"}
//                       {selfRequest.final_outcome === "REJECTED" && "Resignation Not Approved"}
//                       {selfRequest.final_outcome === "WITHDRAWN" && "Resignation Withdrawn"}
//                     </h2>
//                     {selfRequest.final_outcome === "RESIGNED" && (
//                       <>
//                         <p className="exit-flow-outcome-message">
//                           Your resignation is final. Contact HR if needed.
//                           <br />
//                           <strong>Last Working Day:</strong>{" "}
//                           {selfRequest.final_lwd
...
//                                 <div className="exit-flow-tabs">
//                                   <button
//                                     className={`exit-flow-tab ${clearanceActiveTab === "kt" ? "exit-flow-tab--active" : ""}`}
//                                     onClick={() => setClearanceActiveTab("kt")}
//                                   >
//                                     KT Plan
//                                   </button>
//                                   <button
//                                     className={`exit-flow-tab ${clearanceActiveTab === "assets" ? "exit-flow-tab--active" : ""}`}
//                                     onClick={() => setClearanceActiveTab("assets")}
//                                   >
//                                     Assets
//                                   </button>
...
//                     )}
//                     {selfRequest.final_outcome === "REJECTED" && (
//                       <p className="exit-flow-outcome-message text-sm mt-4">
//                         Previous resignation was rejected.
//                       </p>
//                     )}
//                     {selfRequest.final_outcome === "WITHDRAWN" && (
...
//                     <h2 className="exit-flow-title">Submit Resignation Request</h2>
//                     <form className="exit-flow-form">
//                       <div className="exit-flow-form-group">
//                         <label>Reason for leaving</label>
//                         <select
//                           value={form.reason}
//                           onChange={(e) => setForm({ ...form, reason: e.target.value })}
...
//                       <button
//                         type="button"
//                         className="btn btn-primary exit-flow-full-width"
//                         onClick={handleApply}
//                         disabled={loading}
//                       >
//                         {loading ? "Submitting..." : "Submit Resignation"}
...
//                 )}
//                 {selectedRequest.type === "withdrawal" && (
//                   <div className="exit-flow-modal-row exit-flow-full-width">
//                     <span className="exit-flow-modal-label">Withdrawal Reason</span>
//                     <span className="exit-flow-modal-value">{selectedRequest.withdrawal_reason}</span>
//                   </div>
//                 )}
...
//           <div className="exit-flow-modal-backdrop">
//             <div className="exit-flow-modal-content" style={{ maxWidth: '520px' }}>
//               <div className="exit-flow-kt-modal-header">
//                 <h3 className="exit-flow-kt-modal-title">
//                   {editingKtId ? "Edit Knowledge Transfer Plan" : "Add Knowledge Transfer Plan"}
//                 </h3>
//                 <button
//                   onClick={() => {
...
//                     setEditingKtId(null);
//                   }}
//                   className="exit-flow-kt-modal-close"
//                 >
//                   ×
//                 </button>
//               </div>
//               <div className="exit-flow-kt-modal-body">
//                 <div className="exit-flow-kt-form-group">
//                   <label className="exit-flow-kt-form-label">
//                     Topic <span className="exit-flow-kt-required">*</span>
//                   </label>
//                   <input
//                     type="text"
//                     value={editingKtId ? editKtForm.topic : newKtForm.topic}
...
//                         : setNewKtForm({ ...newKtForm, topic: e.target.value })
//                     }
//                     className="exit-flow-kt-form-input"
//                     placeholder="e.g. CRM Dashboard Training"
//                   />
//                 </div>
//                 <div className="exit-flow-kt-form-group">
//                   <label className="exit-flow-kt-form-label">
//                     Description <span className="exit-flow-kt-required">*</span>
//                   </label>
//                   <textarea
//                     value={editingKtId ? editKtForm.description : newKtForm.description}
//                     onChange={(e) =>
...
//                     }
//                     rows={5}
//                     className="exit-flow-kt-form-textarea"
//                     placeholder="Detailed notes about what needs to be handed over..."
//                   />
//                 </div>
//                 <div className="exit-flow-kt-form-group">
//                   <label className="exit-flow-kt-form-label">Upload Documents (multiple allowed)</label>
//                   <div className="exit-flow-kt-file-upload-container">
//                     <label className="exit-flow-kt-file-upload-btn">
//                       Choose files
//                       <input
//                         type="file"
//                         multiple
...
//                           }
//                         }}
//                         className="exit-flow-kt-file-input-hidden"
//                       />
//                     </label>
//                     <span className="exit-flow-kt-file-selected">
//                       {(editingKtId ? editKtForm.documents : newKtForm.documents).length > 0
//                         ? `Selected: ${(editingKtId ? editKtForm.documents : newKtForm.documents)
//                             .map(f => f.name)
//                             .join(", ")}`
...
//                   )}
//                 </div>
//                 <div className="exit-flow-kt-form-row">
//                   <div className="exit-flow-kt-form-group exit-flow-kt-form-group-half">
//                     <label className="exit-flow-kt-form-label">Status</label>
//                     <select
//                       value={editingKtId ? editKtForm.status : newKtForm.status}
//                       onChange={(e) =>
//                         editingKtId
...
//                           : setNewKtForm({ ...newKtForm, status: e.target.value })
//                       }
//                       className="exit-flow-kt-form-select"
//                     >
//                       <option value="">Select status</option>
//                       <option value="pending">Pending</option>
//                       <option value="in-progress">In Progress</option>
...
//                   </div>
//                   <div className="exit-flow-kt-form-group exit-flow-kt-form-group-half">
//                     <label className="exit-flow-kt-form-label">Completed Date</label>
//                     <input
//                       type="date"
//                       value={editingKtId ? editKtForm.completedDate : newKtForm.completedDate}
//                       onChange={(e) =>
...
//                 </div>
//               </div>
//               <div className="exit-flow-kt-modal-footer">
//                 <button
//                   onClick={() => {
//                     setShowAddKTModal(false);
//                     setEditingKtId(null);
//                   }}
//                   className="exit-flow-kt-btn exit-flow-kt-btn--cancel"
//                 >
//                   Cancel
//                 </button>
//                 <button
...
//                     !(editingKtId ? editKtForm.topic.trim() && editKtForm.description.trim() : newKtForm.topic.trim() && newKtForm.description.trim())
//                   }
//                   className="exit-flow-kt-btn exit-flow-kt-btn--primary"
//                 >
//                   {loading
//                     ? "Saving..."
//                     : editingKtId
...
{selectedRequest?.type === "normal" && role === "hr" && (
  <div className="exf-full-width mt-6">
        ...
        {ktPlans.length === 0 ? (
          ...
          ktPlans.map((kt) => (
            <div key={kt.id} className="exf-card relative">
              ...
              {kt.description && (
                <p className="exf-card-description">{kt.description}</p>
              )}

              {kt.attached_files?.length > 0 && (
                <div className="exf-files-section mt-4">
                  <p className="exf-files-title">Uploaded files:</p>
                  <div className="space-y-2 mt-2">
                    {kt.attached_files.map((file, idx) => {
                      ...
                      return (
                        <div
                          key={idx}
                          className="exf-file-item"
                        >
                          <span className="exf-file-name truncate flex-1">{fileName}</span>
                          <div className="exf-file-actions">
                            <button
                              className="exf-btn exf-btn-secondary exf-btn-sm"
                              onClick={() => viewFile(file)}
                            >
                              View
                            </button>
                            <button
                              className="exf-btn exf-btn-outline exf-btn-sm"
                              onClick={() => downloadFile(file, fileName)}
                            >
                              Download
                            </button>
  ...
  <label className="exf-checkbox-label">
    <input
      ...
      className="exf-checkbox"
    />
    <span>HR/Admin Approved</span>   {/* optional: change label text */}
  </label>
)}
              </div>
