...
//       {showEmployeesModal && (
//         <div className="office_loc-office-modal-overlay">
// <div className="office_loc-office-modal office_loc-employee-modal">            <div className="office_loc-office-modal-header">
//               <div>
...
//               ) : (
// <div className="office_loc-employee-list">                  {filteredEmployees.map((employee) => {
...
{showModal && (
  <div className="office_loc-office-modal-overlay">
    <div 
      className="office_loc-office-modal" 
      style={{ 
        width: "650px", 
        maxWidth: "92%", 
        maxHeight: "78vh",   // ← Reduced height
        display: "flex",
    ...
    >
      ...
      <div className="office_loc-office-modal-body" style={{ flex: 1, overflowY: "auto" }}>
        {/* Error Message */}
        {formError && (
          <div
            style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: "13px", color: "#555", display: "block", marginTop: "3px" }}>
            Right-click → "What's here?" to copy Lat, Long
          </span>
        </div>
