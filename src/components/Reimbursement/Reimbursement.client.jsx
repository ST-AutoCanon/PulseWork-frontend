          ...
          {filteredReimbursements.map((claim) => (
            <div
              ...
              className={`expense-card ${
                expandedCard === claim.id ? "open" : ""
              }`}
              onClick={() =>
                setExpandedCard(expandedCard === claim.id ? null : claim.id)
              }
            >
              <div className="card-top">
                <div className="left">
                  ...
                  <div>
                    ...
                    <div className="date">
                      {formatDisplayDate(claim.date || claim.from_date)}
                    </div>
                  </div>
                </div>
              ...
              <div className="card-expand">
                <div className="info">
                  <div>
                    <span>Purpose</span> <span>{claim.purpose || "—"}</span>
                  </div>
                  <div>
                    <span>Comments</span>{" "}
                    <span>{claim.approver_comments || "None"}</span>
                  </div>
                </div>
        ...
        <div className="rb-modal">
          <div className="rb-modal-content">
            ...
            <form
              ...
              onSubmit={isMobile ? handleStepSubmit : handleSubmit}
            >
              {!isMobile ? (
                <>
                  <div className="claim-type">
