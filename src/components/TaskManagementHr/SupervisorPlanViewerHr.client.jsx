...
const SupervisorPlanViewerHr = () => {
  ...
  const getTaskDateStyle = (dateString, employeeId) => {
    if (!dateString)
      return {
        className:
          "supervisor-plan-hr-task-date supervisor-plan-hr-task-date-regular",
        tooltip: "N/A",
      };
    ...
    if (isApprovedLeave)
      return {
        className: "supervisor-plan-hr-task-date supervisor-plan-hr-task-date-leave",
        tooltip: "Leave",
      };
    if (isHoliday)
      return {
        className:
          "supervisor-plan-hr-task-date supervisor-plan-hr-task-date-holiday",
        tooltip: "Holiday",
      };
    if (isSunday)
      return {
        className: "supervisor-plan-hr-task-date supervisor-plan-hr-task-date-sunday",
        tooltip: "Sunday",
      };
    return {
      className: "supervisor-plan-hr-task-date supervisor-plan-hr-task-date-regular",
  ...
  if (!hydrated)
    return <div className="supervisor-plan-hr-wrapper">Loading user...</div>;
  if (!user)
    return (
            ...
            <div className="supervisor-plan-hr-tasks-container">
              {weekDays.map(({ dateStr, dateDisplay }) => {
                ...
                return (
                  <div
                    key={dateStr}
                    className="supervisor-plan-hr-day-group"
                  >
                    ...
                    {dayTasks.length === 0 ? (
                      <p className="supervisor-plan-hr-no-tasks">
                      ...
                      dayTasks.map((task) => {
                        ...
                        return (
                          <div
                            key={task.task_id}
                            className={`supervisor-plan-hr-task-card ${
                              isFrozen
                                ? "supervisor-plan-hr-task-frozen"
                                : ""
                            }`}
                          >
                            <div className="supervisor-plan-hr-task-header">
                              ...
                              <div className="supervisor-plan-hr-task-meta">
                                {effectiveReviewStatus !== "pending" && (
                                  <span className="supervisor-plan-hr-status-icon">
                            ...
                            {isFrozen && (
                              <div className="supervisor-plan-hr-frozen-message">
                                This task is suspended and frozen. No edits
                                allowed.
                              </div>
                            )}
                            <div
                              className={`supervisor-plan-hr-edit-section ${
                                isFrozen
                                  ? "supervisor-plan-hr-edit-section-disabled"
                                  : ""
                              }`}
                            >
                              <label>
                              ...
                              {effectiveReviewStatus !== "pending" && (
                                <label>
                                  Rating:
                                  <div className="supervisor-plan-hr-star-rating">
                                    {[1, 2, 3, 4, 5].map((star) => (
                                      <span
                                        key={star}
                                        className={`supervisor-plan-hr-star ${
                              ...
                              <button
                                className="supervisor-plan-hr-update-task-button"
