...
//   // Fetch employees, holidays, leaves
//   useEffect(() => {
//     if (!hrId) return;
...
//           { withCredentials: true, headers: apiHeaders, timeout: 10000 }
//         );
//         setHolidays(Array.isArray(res.data.holidays) ? res.data.holidays.map(h => h.date) : []);
//       } catch {
//         setHolidays([]);
//       } finally {
...
//           { params: { employeeId: selectedEmployee }, withCredentials: true, headers: apiHeaders, timeout: 10000 }
//         );
//         const newProjects = {};
//         (res.data.projects || []).forEach(p => { newProjects[p.id] = p.project; });
...
//                               <p>
//                                 <strong>Emp-Update:</strong> {task.emp_comment || "—"}
//                               </p>
//                             </div>

//                             <div className="supervisor-plan-hr-review-info">
//                               <p><strong>Supervisor Status:</strong> {task.sup_status || "—"}</p>
//                               <p><strong>Supervisor Comment:</strong> {task.sup_comment || "—"}</p>
//                               <p><strong>Rating:</strong> {task.star_rating ? "★".repeat(task.star_rating) : "—"}</p>
//                             </div>
//                           </div>
//                         );
//                       })
...
//       case "struck":
//         return { color: "#ffc107", label: "Struck / Needs Update", icon: "⚠️" };
