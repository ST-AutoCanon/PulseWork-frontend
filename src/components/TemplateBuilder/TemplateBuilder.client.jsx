...
export default function TemplateBuilder() {
  ...
  async function fetchPublicBasicTemplates() {
    ...
    try {
      ...
      console.log(
        "[fetchPublicBasicTemplates] loading local manifest",
        manifestUrl
      );
      ...
      console.log(
        "[fetchPublicBasicTemplates] loaded local manifest:",
        loaded.length
      );
  ...
  async function openSavedTemplate(template) {
    console.log(
      "openSavedTemplate called for template id:",
    ...
    try {
      ...
      console.log("openSavedTemplate: resolved ->", resolved);
      ...
      console.log(
        "openSavedTemplate: raw header candidates ->",
        headerCandidates
      );
      ...
      if (!rawHeader || !rawFooter) {
        ...
        console.log(
          "openSavedTemplate: upload-like strings found in template ->",
          found
        );
      ...
      console.log("openSavedTemplate: header ->", headerBlobUrl);
      console.log("openSavedTemplate: footer ->", footerBlobUrl);

      setPreviewHeaderUrl(headerBlobUrl || null);
      setPreviewFooterUrl(footerBlobUrl || null);

      console.log(
        "openSavedTemplate: computed headerBlobUrl ->",
        headerBlobUrl,
        " footerBlobUrl ->",
        footerBlobUrl
      );
